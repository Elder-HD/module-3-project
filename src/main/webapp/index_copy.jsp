...
<body>
    <div class="header">
        <h1>ТРОХИ ІСТОРІЇ</h1>
        <a class="quest-button" href="/quest">Читати</a>
    </div>
    <div class="main">
        <div class="main__content">
            <h2 class="main__content">Lorem ipsum</h2>
            <p class="main__content"><b>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore
                magna aliqua. Nisl pretium fusce id velit ut. </b></p>
            <p class="main__content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut labore et dolore
        ...
        <img class="hello-img" src="static/img/hello.img" alt="hello.img"/>
    </div>
